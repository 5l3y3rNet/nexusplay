      ...
      <div style={{ width: "100%", maxWidth: "23rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          <a href="/" style={{ textDecoration: "none" }}>
            <span style={{ fontWeight: 800, color: "#fafafa", fontSize: "1.75rem", letterSpacing: "0.05em" }}>KAN<span style={{ color: "#fafafa" }}>I</span></span>
          </a>
        ...
        <form onSubmit={handleSubmit} style={{ background: "#111113", border: "1px solid #27272a", borderRadius: "1rem", padding: "1.75rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <button type="submit" disabled={loading} style={{ background: loading ? "#52525b" : "#fafafa", color: "#09090b", fontWeight: 700, fontSize: "1rem", padding: "0.8125rem", borderRadius: "0.75rem", border: "none", cursor: loading ? "not-allowed" : "pointer" }}>
