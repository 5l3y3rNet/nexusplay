...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#080a0f", padding: "1.25rem" }}>
      <div style={{ width: "100%", maxWidth: "23rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.9375rem", color: "#71757f" }}>Use the credentials provided by KANI</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ background: "#0c0e16", border: "1px solid #161a26", borderRadius: "1rem", padding: "1.75rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <button type="submit" disabled={loading} style={{ background: loading ? "#a8741a" : "#f5a623", color: "#09090b", fontWeight: 700, fontSize: "1rem", padding: "0.8125rem", borderRadius: "0.75rem", border: "none", cursor: loading ? "not-allowed" : "pointer" }}>
