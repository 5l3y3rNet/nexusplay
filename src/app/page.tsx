  ...
  return (
    <div style={{ paddingTop: "4rem" }}>
      ...
      <section style={{ background: "#09090b", minHeight: "90vh", display: "flex", alignItems: "center", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at 50% 0%, rgba(99,102,241,0.08) 0%, transparent 65%)", pointerEvents: "none" }} />
      ...
      <section style={{ background: "#09090b", borderTop: "1px solid #27272a", padding: "4rem 0" }}>
        <div style={{ maxWidth: "80rem", margin: "0 auto", padding: "0 1.25rem" }}>
          <div style={{ maxWidth: "36rem", marginBottom: "3rem" }}>
            <p style={{ fontSize: "0.6875rem", fontFamily: "monospace", color: "#52525b", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "0.5rem" }}>Platform</p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "1px", background: "#27272a" }}>
            {features.map((f, i) => (
              <div key={i} style={{ background: "#09090b", padding: "1.75rem" }}>
                <div style={{ width: "2.25rem", height: "2.25rem", background: "#18181b", border: "1px solid #27272a", borderRadius: "0.5rem", display: "flex", alignItems: "center", justifyContent: "center", color: "#71717a", marginBottom: "1rem" }}>{f.icon}</div>
      ...
      <section style={{ background: "#09090b", borderTop: "1px solid #27272a", padding: "4rem 0" }}>
        <div style={{ maxWidth: "80rem", margin: "0 auto", padding: "0 1.25rem" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "3rem", alignItems: "center" }}>
            <div>
              <p style={{ fontSize: "0.6875rem", fontFamily: "monospace", color: "#52525b", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "0.5rem" }}>Integration</p>
