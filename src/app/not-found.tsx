...
export default function NotFound() {
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#09090b", padding: "1rem" }}>
      <div style={{ textAlign: "center" }}>
        <div style={{ fontSize: "5rem", fontWeight: 700, color: "#27272a", fontFamily: "monospace", lineHeight: 1, marginBottom: "1.5rem" }}>404</div>
