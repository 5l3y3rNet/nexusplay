...
export default function AdminLoginPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#070a14", padding: "1.25rem" }}>
      <div style={{ width: "100%", maxWidth: "23rem" }}>
        ...
        <form onSubmit={handleSubmit} style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "1rem", padding: "1.75rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <button type="submit" disabled={loading} style={{ background: loading ? "#444" : "#fafafa", color: "#090D1A", fontWeight: 700, fontSize: "1rem", padding: "0.8125rem", borderRadius: "0.75rem", border: "none", cursor: loading ? "not-allowed" : "pointer" }}>
