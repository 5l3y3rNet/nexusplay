  ...
  if (notFound) {
    return (
      <div style={{ minHeight: "100vh", background: "#09090b", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "1rem", fontFamily: "system-ui" }}>
        ...
        <button onClick={() => router.push("/games")} style={{ background: "#f5a623", color: "#09090b", border: "none", borderRadius: "0.5rem", padding: "0.625rem 1.25rem", cursor: "pointer", fontWeight: 700 }}>Browse Games</button>
      </div>
    );
  }
