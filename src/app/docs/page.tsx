    ...
    <div style={{ paddingTop: "4rem", minHeight: "100vh", background: "#090D1A" }}>
      <div style={{ maxWidth: "80rem", margin: "0 auto", padding: "3.5rem 1.5rem" }}>
        ...
        <div style={{ maxWidth: "42rem", marginBottom: "3.5rem" }}>
          ...
          <h1 style={{ fontSize: "2.25rem", fontWeight: 700, color: "#fafafa", marginBottom: "1rem" }}>KANI API Docs</h1>
          <p style={{ color: "#71717a", lineHeight: 1.7 }}>Everything you need to integrate KANI games into your casino platform. Start with the quick-start guide or jump straight to the API reference.</p>
        </div>

        {/* Quick start callout */}
        <div style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "0.75rem", padding: "1.5rem", marginBottom: "3rem", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1rem" }}>
          <div>
            <div style={{ fontWeight: 600, color: "#fafafa", marginBottom: "0.375rem" }}>New to KANI?</div>
          ...
          <Link href="/docs/getting-started" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "#f5a623", color: "#090D1A", fontWeight: 600, fontSize: "0.875rem", padding: "0.625rem 1.25rem", borderRadius: "0.375rem", textDecoration: "none", flexShrink: 0 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "1rem", marginBottom: "3rem" }}>
          {docSections.map((section) => (
            <Link key={section.title} href={section.href} style={{ textDecoration: "none" }}>
              <div style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "0.75rem", padding: "1.5rem", height: "100%", transition: "border-color 0.15s" }}
                
                >
                <div style={{ width: "2.25rem", height: "2.25rem", background: "#131a2e", border: "1px solid #1e2740", borderRadius: "0.5rem", display: "flex", alignItems: "center", justifyContent: "center", color: "#71717a", marginBottom: "1rem" }}>
                  {section.icon}
                </div>
        ...
        <div style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "0.75rem", overflow: "hidden" }}>
          <div style={{ padding: "1.5rem", borderBottom: "1px solid #1e2740" }}>
          ...
          <div style={{ padding: "1.5rem" }}>
            <pre style={{ background: "#131a2e", border: "1px solid #1e2740", borderRadius: "0.5rem", padding: "1rem", fontFamily: "monospace", fontSize: "0.75rem", color: "#a1a1aa", lineHeight: 1.75, overflow: "auto", margin: 0 }}>
