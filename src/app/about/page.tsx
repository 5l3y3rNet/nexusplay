...
export default function AboutPage() {
  return (
    <div style={{ paddingTop: "4rem", background: "#090D1A" }}>

      {/* HERO */}
      <section style={{ borderBottom: "1px solid #131a2e", padding: "5rem 0 4rem" }}>
      ...
      <section style={{ padding: "4rem 0", borderBottom: "1px solid #131a2e" }}>
        <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "0 1.25rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1rem" }}>
            {principles.map((p, i) => (
              <div key={i} style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "1rem", padding: "1.75rem", display: "flex", flexDirection: "column", gap: "0.875rem" }}>
      ...
      <section style={{ padding: "4rem 0", borderBottom: "1px solid #131a2e" }}>
        <div style={{ maxWidth: "60rem", margin: "0 auto", padding: "0 1.25rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1.25rem" }}>
            {founders.map((f, i) => (
              <div key={i} style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "1rem", padding: "1.75rem", display: "flex", gap: "1.25rem", alignItems: "flex-start" }}>
                <div style={{ flexShrink: 0, width: "3.5rem", height: "3.5rem", borderRadius: "0.875rem", background: "linear-gradient(135deg, #f5a623, #d4881a)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.5rem", fontWeight: 800, color: "#090D1A" }}>{f.initial}</div>
                <div>
      ...
      <section style={{ padding: "4rem 0", borderBottom: "1px solid #131a2e" }}>
        <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "0 1.25rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "1px", background: "#1e2740", border: "1px solid #1e2740", borderRadius: "1rem", overflow: "hidden" }}>
            {bring.map((b, i) => (
              <div key={i} style={{ background: "#0f1424", padding: "1.75rem" }}>
      ...
      <section style={{ padding: "4rem 0", borderBottom: "1px solid #131a2e" }}>
        <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "0 1.25rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem" }}>
            {drives.map((d, i) => (
              <div key={i} style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "1rem", padding: "1.75rem", position: "relative" }}>
                <div style={{ fontSize: "2.5rem", fontWeight: 800, color: "#1e2740", fontFamily: "monospace", lineHeight: 1, marginBottom: "0.75rem" }}>0{i + 1}</div>
      ...
      <section style={{ padding: "5rem 0" }}>
        <div style={{ maxWidth: "44rem", margin: "0 auto", padding: "0 1.25rem", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem", justifyContent: "center" }}>
            <Link href="/partner" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "#f5a623", color: "#090D1A", fontWeight: 700, fontSize: "0.9375rem", padding: "0.875rem 1.75rem", borderRadius: "0.625rem", textDecoration: "none" }}>
              Partner with us <ArrowRight size={16} />
            </Link>
            <Link href="/games" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "#131a2e", border: "1px solid #1e2740", color: "#fafafa", fontWeight: 600, fontSize: "0.9375rem", padding: "0.875rem 1.75rem", borderRadius: "0.625rem", textDecoration: "none" }}>
              See the games
            </Link>
          </div>
        </div>
