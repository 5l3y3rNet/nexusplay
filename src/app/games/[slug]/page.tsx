      ...
      <div style={{ maxWidth: "80rem", margin: "0 auto", padding: "2rem 1.25rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "1.5rem" }} className="lg:grid-cols-game">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            <div style={{ borderRadius: "0.75rem", overflow: "hidden", background: "#131a2e", border: "1px solid #1e2740", aspectRatio: "16/9" }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "1rem" }}>
              <div>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "0.375rem", marginBottom: "0.5rem" }}>
                  ...
                  <span style={{ fontSize: "0.625rem", background: "#131a2e", color: "#a1a1aa", border: "1px solid #3f3f46", padding: "0.125rem 0.5rem", borderRadius: "0.25rem", fontFamily: "monospace" }}>{game.category}</span>
                </div>
            ...
            <div style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "0.75rem", padding: "1.25rem" }}>
            ...
            <div style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "0.75rem", padding: "1.25rem" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                {([["Game ID",game.id,"mono"],["Category",game.category,""],["RTP",game.rtp,"green"],["Volatility",game.volatility,"vol"],["Min Bet",game.minBet,""],["Max Bet",game.maxBet,""],["Max Win",game.maxWin,""],["Release",game.releaseDate,"mono"]] as [string,string,string][]).map(([lbl,val,type]) => (
                  <div key={lbl} style={{ borderBottom: "1px solid #1e2740", paddingBottom: "0.75rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0.75rem" }}>
              {[{t:"Devices",items:game.devices},{t:"Currencies",items:game.currencies},{t:"Languages",items:game.languages}].map(({t,items}) => (
                <div key={t} style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "0.75rem", padding: "1rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "0.75rem", padding: "1.25rem" }}>
              ...
              <div style={{ marginBottom: "0.75rem" }}>
                ...
                <div style={{ background: "#131a2e", border: "1px solid #1e2740", borderRadius: "0.375rem", padding: "0.5rem 0.75rem", fontSize: "0.8125rem", fontFamily: "monospace", color: "#a1a1aa" }}>{game.id}</div>
              </div>
              <div style={{ background: "#131a2e", border: "1px solid #1e2740", borderRadius: "0.5rem", padding: "0.875rem", marginBottom: "1rem" }}>
...
{JSON.stringify({gameId:game.id,playerId:"player_xyz",currency:"USD",balance:1000},null,2)}
              ...
              <Link href="/partner" style={{ display: "flex", alignItems: "center", justifyContent: "center", background: "#f5a623", color: "#090D1A", fontWeight: 700, fontSize: "0.875rem", padding: "0.75rem", borderRadius: "0.375rem", textDecoration: "none" }}>
                Get API Access
              </Link>
            </div>
            ...
            <div style={{ background: "#0f1424", border: "1px solid #1e2740", borderRadius: "0.75rem", padding: "1.25rem" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                {game.tags.map(tag => <span key={tag} style={{ fontSize: "0.75rem", background: "#131a2e", border: "1px solid #1e2740", color: "#71717a", padding: "0.25rem 0.625rem", borderRadius: "0.375rem", fontFamily: "monospace" }}>#{tag}</span>)}
              </div>
            </div>
