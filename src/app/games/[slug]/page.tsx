...
{JSON.stringify({gameId:game.id,playerId:"player_xyz",currency:"USD",balance:1000},null,2)}
              ...
              <Link href="/partner" style={{ display: "flex", alignItems: "center", justifyContent: "center", background: "#f5a623", color: "#09090b", fontWeight: 700, fontSize: "0.875rem", padding: "0.75rem", borderRadius: "0.375rem", textDecoration: "none" }}>
                Get API Access
              </Link>
            </div>
