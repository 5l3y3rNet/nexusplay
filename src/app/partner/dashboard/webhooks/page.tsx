      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <header style={{ height: "4rem", borderBottom: "1px solid #27272a", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 1.5rem", flexShrink: 0 }}>
          ...
          <div style={{ display: "flex", gap: "0.5rem" }}>
            ...
            <button onClick={() => { setShowNew(true); setNewSecret(""); }} style={{ display: "inline-flex", alignItems: "center", gap: "0.375rem", background: "#fafafa", color: "#09090b", fontSize: "0.75rem", fontWeight: 600, padding: "0.375rem 0.75rem", borderRadius: "0.375rem", border: "none", cursor: "pointer" }}>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.7)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 50, padding: "1rem" }}>
          <div style={{ background: "#18181b", border: "1px solid #27272a", borderRadius: "0.75rem", padding: "1.5rem", width: "100%", maxWidth: "26rem" }}>
            ...
            <div style={{ display: "flex", gap: "0.75rem" }}>
              <button onClick={createHook} disabled={creating} style={{ flex: 1, background: "#fafafa", color: "#09090b", fontWeight: 600, fontSize: "0.875rem", padding: "0.5rem", borderRadius: "0.375rem", border: "none", cursor: "pointer" }}>
