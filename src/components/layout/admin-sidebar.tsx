    ...
    <aside style={{ display: "flex", flexDirection: "column", width: "14rem", borderRight: "1px solid #1c1f2b", background: "#0a0b10", height: "100%" }}>
      ...
      <nav style={{ flex: 1, padding: "0.75rem", overflowY: "auto" }}>
        ...
        {navItems.map(item => {
          ...
          return (
            <Link key={item.label} href={item.href} style={{ display: "flex", alignItems: "center", gap: "0.625rem", padding: "0.625rem 0.75rem", borderRadius: "0.5rem", textDecoration: "none", fontSize: "0.9375rem", marginBottom: "0.125rem", background: active ? "#161a26" : "transparent", color: active ? "#fafafa" : "#8b8f9b" }}>
